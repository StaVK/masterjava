...
public abstract class UserDao implements AbstractDao {
    ...
    @SqlUpdate("INSERT INTO users (full_name, email, flag, code) VALUES (:fullName, :email, CAST(:flag AS USER_FLAG), :code) ")
    @GetGeneratedKeys
    abstract int insertGeneratedId(@BindBean User user);

    @SqlUpdate("INSERT INTO users (id, full_name, email, flag, code) VALUES (:id, :fullName, :email, CAST(:flag AS USER_FLAG), :code) ")
    ...
    @SqlBatch("INSERT INTO users (id, full_name, email, flag, code) VALUES (:id, :fullName, :email, CAST(:flag AS USER_FLAG), :code)" +
